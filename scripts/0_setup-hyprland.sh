...
sudo paru -S --needed --noconfirm waybar bitwarden tumbler firefox swww thunar \
  ...
  ripgrep lua51 luarocks wget stow python-pip python-pynvim wl-clipboard htop kitty thunar-archive-plugin ranger
...
sudo cp ~/.dotfiles-cachyos/wallpapers/the-sphere.png ~/.config/hypr/wallpaper.png
